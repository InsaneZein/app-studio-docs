...
var ConnectedBreadcrumbs = function (props) {
    ...
    return (react_1.default.createElement(Breadcrumbs_1.default, __assign({}, props, { items: mappedBreadcrumbs.slice(0, -1).map(function (item) { return ({ title: item, navigate: item }); }), onNavigate: onNavigate, current: mappedBreadcrumbs.slice(-1)[0] })));
};
