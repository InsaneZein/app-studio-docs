...
var PaginationNext = function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({ className: "pf-c-pagination pf-m-footer ".concat(className), "aria-label": "Element pagination" }, props),
        react_1.default.createElement(PaginationMenu_1.default, { itemsStart: itemsStart, itemsEnd: itemsEnd, widtgetId: widtgetId, dropDirection: dropDirection, onSetPerPage: onSetPerPage, itemCount: itemCount, perPage: perPage, perPageOptions: perPageOptions }),
        react_1.default.createElement(PaginationNav_1.default, { lastPage: lastPage, page: page, setPage: setPage, onFirstPage: onFirstPage, onLastPage: onLastPage, onPreviousPage: onPreviousPage, onNextPage: onNextPage })));
};
