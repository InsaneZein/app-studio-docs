...
var BulkSelect = function (_a) {
    ...
    var ouiaStateId = (0, react_1.useRef)((0, react_core_2.getDefaultOUIAId)('RHI/BulkSelect')).current;
    var onToggle = function (isOpen) { return setIsOpen(isOpen); };
    var ouiaFinalId = ouiaId !== undefined ? ouiaId : ouiaStateId;
    return (react_1.default.createElement(react_1.Fragment, null, items && items.length > 0 ? (react_1.default.createElement(react_core_1.Dropdown, __assign({ onSelect: function () { return onToggle(false); } }, props, { className: (0, classnames_1.default)(className, 'ins-c-bulk-select'), ouiaId: ouiaFinalId, ouiaSafe: ouiaSafe, toggle: react_1.default.createElement(react_core_1.DropdownToggle, __assign({}, toggleProps, { isDisabled: isDisabled, ouiaId: ouiaFinalId, splitButtonItems: [
                react_1.default.createElement(react_1.Fragment, { key: "split-checkbox" }, hasError ? (react_1.default.createElement(react_core_1.DropdownToggleCheckbox, { id: id ? "".concat(id, "-toggle-checkbox") : 'toggle-checkbox', "aria-label": "Select all", onChange: onSelect, checked: checked, ouiaId: ouiaFinalId })) : (react_1.default.createElement(react_core_1.DropdownToggleCheckbox, { id: id ? "".concat(id, "-toggle-checkbox") : 'toggle-checkbox', "aria-label": "Select all", onChange: onSelect, isChecked: checked, ouiaId: ouiaFinalId }, count ? "".concat(count, " selected") : ''))),
            ], onToggle: onToggle })), isOpen: isOpen, dropdownItems: __spreadArray(__spreadArray([], (count !== undefined && count > 0
            ? [
                react_1.default.createElement(react_core_1.DropdownItem, { key: "count", isDisabled: true, className: (0, classnames_1.default)({
                        'ins-c-bulk-select__selected': !hasError,
                    }) },
                    count,
                    " Selected"),
            ]
            : []), true), items.map(function (oneItem, key) { return (react_1.default.createElement(react_core_1.DropdownItem, __assign({ component: "button", key: oneItem.key || key, ouiaId: "".concat(ouiaFinalId, "-").concat(oneItem.key || key), onClick: function (event) { return oneItem.onClick && oneItem.onClick(event, oneItem, key); } }, oneItem === null || oneItem === void 0 ? void 0 : oneItem.props), oneItem.title)); }), true) }))) : (react_1.default.createElement(react_core_1.Checkbox, __assign({}, props, { "aria-label": "Select all", className: (0, classnames_1.default)(className, 'ins-c-bulk-select'), id: "".concat(id, "-checkbox"), isChecked: checked, onChange: onSelect })))));
};
