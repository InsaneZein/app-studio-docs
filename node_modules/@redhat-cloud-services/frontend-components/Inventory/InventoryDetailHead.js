...
var BaseInventoryDetailHead = function (props) {
    ...
    return (react_1.default.createElement(Cmp, { className: (0, classnames_1.default)(props.className, 'inventory') },
        react_1.default.createElement(react_1.Suspense, { fallback: props.fallback },
            react_1.default.createElement(react_core_1.ScalprumComponent, __assign({ history: history, store: store, appName: "inventory", module: "./InventoryDetailHead", scope: "inventory", ErrorComponent: react_1.default.createElement(InventoryLoadError_1.default, __assign({ component: "InventoryDetailHead", history: history, store: store }, props)), ref: props.innerRef }, props)))));
};
