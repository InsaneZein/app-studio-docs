...
exports.reduxRegistry = exports.ReducerRegistry = exports.dispatchActionsToStore = exports.applyReducerHash = void 0;
...
var ReducerRegistry = (function () {
    function ReducerRegistry(initState, middlewares, composeEnhancersDefault) {
        ...
        if (composeEnhancersDefault === void 0) { composeEnhancersDefault = redux_1.compose; }
        var composeEnhancers = (typeof window !== 'undefined' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__) || composeEnhancersDefault;
        this.store = (0, redux_1.createStore)(function (state) {
            if (state === void 0) { state = initState; }
            return state;
        }, initState, composeEnhancers(redux_1.applyMiddleware.apply(void 0, middlewares)));
        this.reducers = {};
    }
    ...
    ReducerRegistry.prototype.register = function (newReducers) {
        ...
        return function () {
            ...
            _this.store.replaceReducer((0, redux_1.combineReducers)(__assign({}, _this.reducers)));
        };
    };
    return ReducerRegistry;
}());
exports.ReducerRegistry = ReducerRegistry;
exports.reduxRegistry = new ReducerRegistry();
