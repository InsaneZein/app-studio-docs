...
var RouterParams = (function (_super) {
    ...
    RouterParams.prototype.componentDidMount = function () {
        ...
        if ((0, react_router_dom_1.matchPath)(location.pathname, { path: url, exact: true })) {
            onPathChange &&
                onPathChange({
                    params: params,
                    path: path,
    ...
    RouterParams.prototype.componentDidUpdate = function () {
        ...
        if (routerData && (!(0, isEqual_1.default)(params, routerData.params) || path !== routerData.path)) {
            if ((0, react_router_dom_1.matchPath)(location.pathname, { path: url, exact: true })) {
                onPathChange &&
                    onPathChange({
                        params: params,
...
var routerParams = function (Component) {
    ...
    }); })(function (props) { return react_1.default.createElement(RouterParams, __assign({}, props, { Component: Component })); }));
};
